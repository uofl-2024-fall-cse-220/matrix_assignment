...
public interface MatrixInterface {
    void setElement(int row, int col, int value) throws MatrixExceptions; //This method will set/update a value in a specific row nad column
    int getElement(int row, int col) throws  MatrixExceptions; //This method will get the value in a specific row and column
